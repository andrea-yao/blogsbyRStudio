...
## 8- Stereochemistry
they are still mirror images, but no matter how I flip them around, the dark lenses won't line up, so they are non-superimposable mirror images. 
\
in chemistry, we say that anything with a non-superimposable mirror images has chirality. 
\ 
we call a pair of these chiral molecules enantiomers. \

## 9- More stereochemical relationships
chiral molecules also have cool interactions with plane-polarized light: a single enantiomer of the chiral molecule can rotate it left or right. 

## 10- polarity, resonance, and electron pushing
for magnets, opposite attract has to do with polarity and physics. \
the structure of molecules informs what they can do and how they react with other chemicals.\
